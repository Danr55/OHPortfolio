...
const About = () => {
    return (
        <div>
            ...
            <img src='https://as2.ftcdn.net/v2/jpg/08/17/59/35/1000_F_817593586_cFIXIlKt7ckw0reThfTJ5crix3fn5qkR.jpg' alt='oscar rendon' className='img-fluid img-md' style={{ width: '100px', height: '100px'}}/>
